...
discrimKMPlot <- function(fit, data, time,lw="none", pal="none", leg.x="none",leg.y="none", leg.title="none",
...
theme_mecPortal <- function(){
    theme(panel.background = element_rect(fill='transparent'), 
        ...
        axis.title.x = element_text(face="italic", colour="white",size = 16),
        axis.title.y = element_text(face = "italic", colour="white",size = 16),
